    ...
    def generate_prometheus_text(self) -> str:
        ...
        with self._lock:
            ...
            if self._http_request_size_count > 0:
                ...
                avg_request_size = self._http_request_size_sum / self._http_request_size_count
            ...
            if self._http_response_size_count > 0:
                ...
                avg_response_size = self._http_response_size_sum / self._http_response_size_count
            ...
            # Requests in flight
            lines.append("")
            lines.append("# HELP http_requests_in_flight Current number of HTTP requests being processed")
